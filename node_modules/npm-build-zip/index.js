...
export async function pack({
    ...
    if (excludePatterns.length) {
        files = await applyExcludes(files, excludePatterns, srcDir);
    }

    return zipFiles(files, filename, srcDir, destination, { info, verbose, timestamp });
}
